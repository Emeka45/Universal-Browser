...
class MainActivity : Activity() {
    ...
    private fun buildToolbar(): View {
        ...
        addressBar = EditText(this).apply { hint = "Search or enter address"; textSize = 14.5f; singleLine = true; setTextColor(ink); setHintTextColor(Color.rgb(145, 143, 158)); setPadding(16.dp(), 0, 14.dp(), 0); background = rounded(surface, 22.dp()); setOnEditorActionListener { _, _, _ -> navigate(text.toString()); true } }
    ...
    private fun buildHomePanel(): View {
        ...
        hero.addView(EditText(this).apply { hint = "Search the web or enter a URL"; textSize = 15f; singleLine = true; setTextColor(ink); setHintTextColor(Color.rgb(125, 123, 140)); setPadding(18.dp(), 0, 18.dp(), 0); background = rounded(white, 19.dp()); elevation = 5.dp().toFloat(); setOnEditorActionListener { _, _, _ -> navigate(text.toString()); true } }, LinearLayout.LayoutParams(-1, 54.dp()))
